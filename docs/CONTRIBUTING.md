...
Pull requests are reviewed by our Claude Code (with human oversight). Address the feedback it raises; once the change is sound and CI is green, it gets merged.
